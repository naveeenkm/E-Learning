...
<?php
            ...
            FROM student s,student_student_phno ssp,enrolls e,completes c,assignment a
            WHERE s.student_id = ssp.student_id  and
             s.student_id = e.student_id and
             s.student_id = c.student_id and
             c.assign_id = a.assign_id and
             e.course_id=a.course_id and
             s.student_id = $courseid
