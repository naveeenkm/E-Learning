...
<?php
        ...
        <thead>
            ...
            <th scope="col">Courses Name you are teaching</th>
        ...
        $courseid = $_GET['courseid'];
        $sql="SELECT f.faculty_id, f.faculty_name, f.faculty_age, f.faculty_exp,c.course_id,course_name
        FROM faculty f
        LEFT JOIN Lectures l ON f.faculty_id = l.faculty_id
        LEFT JOIN Courses c ON l.course_id = c.course_id
        where f.faculty_id=$courseid 
        ...
        $result=mysqli_query($con,$sql);
               ...
               while( $row=mysqli_fetch_array($result)){
                ...
                $coursesTaught1 = $row["course_name"];
